...
public interface CollectorJob {
     ...
     * a worker thread pool, which allows blocking operations inside.
     *
    ...
    /**
     * This method will be called after the {@link #collect(String, JsonObject)} and returns a Future which can be used
     * to do some post collect stuff like rough parsing or saving the result into a database. The Future will be
     * executed in a worker thread pool, which allows blocking operations inside.
     *

...
public class DataCollectorServiceVertxProxyHandler extends ProxyHandler {
  ...
  public DataCollectorServiceVertxProxyHandler(Vertx vertx, DataCollectorService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public DataCollectorServiceVertxProxyHandler(Vertx vertx, DataCollectorService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public DataCollectorServiceVertxProxyHandler(Vertx vertx, DataCollectorService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
    ...
    try {
      ...
      switch (action) {
        ...
        case "getMetricsSnapshot": {
          service.getMetricsSnapshot(createHandler(msg));
          break;
        }
        case "close": {
          service.close();

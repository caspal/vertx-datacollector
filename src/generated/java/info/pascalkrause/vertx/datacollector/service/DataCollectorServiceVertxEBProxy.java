...
public class DataCollectorServiceVertxEBProxy implements DataCollectorService {
  ...
  public DataCollectorServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public DataCollectorServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void collectAndReceive(String requestId, JsonObject feature, Handler<AsyncResult<CollectorJobResult>> resultHandler) {
    ...
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body() == null ? null : new CollectorJobResult(res.result().body())));
                      }
    });
  }
  ...
  public void getMetricsSnapshot(Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getMetricsSnapshot");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
